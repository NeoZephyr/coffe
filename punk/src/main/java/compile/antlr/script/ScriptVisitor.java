...
public interface ScriptVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ScriptParser#typeTypeOrVoid}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypeTypeOrVoid(ScriptParser.TypeTypeOrVoidContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ScriptParser#typeType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypeType(ScriptParser.TypeTypeContext ctx);
	/**
